"""AutoFlow AI - Service for Template.
...
class TemplateService(BaseService[Template, TemplateCreate]):
    """Business service for Template entity.

    Orchestrates Template business logic over the repository layer.
