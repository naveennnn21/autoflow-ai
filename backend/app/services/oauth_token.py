"""AutoFlow AI - Service for OAuthToken.
...
class OAuthTokenService(BaseService[OAuthToken, OAuthTokenCreate]):
    """Business service for OAuthToken entity.

    Orchestrates OAuthToken business logic over the repository layer.
