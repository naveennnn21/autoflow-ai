"""AutoFlow AI - Service for AuditLog.
...
class AuditLogService(BaseService[AuditLog, AuditLogCreate]):
    """Business service for AuditLog entity.

    Orchestrates AuditLog business logic over the repository layer.
