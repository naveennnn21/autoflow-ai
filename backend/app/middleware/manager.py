...
MIDDLEWARE_STACK = [
    ...
    (30, "health", health, {'paths': ['/health', '/health/db', '/readiness']}),
    ...
    (100, "authorization", authorization, {'default_deny': False, 'public_paths': ['/health', '/health/db', '/readiness', '/docs', '/redoc', '/openapi.json']}),
