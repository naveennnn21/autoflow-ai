"""Tests for the ExecutionRepository."""
...
class TestExecutionRepository:
    """Test suite for ExecutionRepository."""
    ...
    async def test_get(self, repo, db_session):
        """Test retrieving a execution by ID."""
        obj_id = uuid.uuid4()
    ...
    async def test_delete_soft(self, repo, db_session):
        """Test soft deleting a execution."""
        obj_id = uuid.uuid4()
        mock_obj = MagicMock(spec=Execution)
        mock_obj.id = obj_id
        mock_result = MagicMock()
    ...
    async def test_delete_hard(self, repo, db_session):
        """Test hard deleting a execution."""
        obj_id = uuid.uuid4()
        mock_obj = MagicMock(spec=Execution)
        mock_obj.id = obj_id
        mock_result = MagicMock()
    ...
    async def test_exists(self, repo, db_session):
        """Test checking if a execution exists."""
        mock_result = MagicMock()
    ...
    async def test_count(self, repo, db_session):
        """Test counting executions with tenant filter."""
        mock_result = MagicMock()
    ...
    async def test_search_pagination(self, repo, db_session):
        """Test searching and paginating executions."""
        mock_obj = MagicMock(spec=Execution)
        mock_result = MagicMock()
