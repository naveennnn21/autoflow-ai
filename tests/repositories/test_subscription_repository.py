"""Tests for the SubscriptionRepository."""
...
class TestSubscriptionRepository:
    ...
    async def test_delete_hard(self, repo, db_session):
        """Test hard deleting a subscription."""
        obj_id = uuid.uuid4()
        mock_obj = MagicMock(spec=Subscription)
        mock_obj.id = obj_id
        mock_result = MagicMock()
    ...
    async def test_exists(self, repo, db_session):
        """Test checking if a subscription exists."""
        mock_result = MagicMock()
    ...
    async def test_count(self, repo, db_session):
        """Test counting subscriptions with tenant filter."""
        mock_result = MagicMock()
    ...
    async def test_search_pagination(self, repo, db_session):
        """Test searching and paginating subscriptions."""
        mock_obj = MagicMock(spec=Subscription)
        mock_result = MagicMock()
    ...
    async def test_bulk_delete(self, repo, db_session):
        """Test bulk deleting subscriptions."""
