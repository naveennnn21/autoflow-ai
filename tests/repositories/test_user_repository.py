...
class TestUserRepository:
    ...
    async def test_count(self, repo, db_session):
        """Test counting users with tenant filter."""
        mock_result = MagicMock()
    ...
    async def test_search_pagination(self, repo, db_session):
        """Test searching and paginating users."""
        mock_obj = MagicMock(spec=User)
        mock_result = MagicMock()
    ...
    async def test_get_by_email(self, repo, db_session):
        ...
        result = await repo.get_by_email("test_value")
        assert result is not None
