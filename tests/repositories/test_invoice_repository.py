"""Tests for the InvoiceRepository."""
...
class TestInvoiceRepository:
    ...
    async def test_get(self, repo, db_session):
        """Test retrieving a invoice by ID."""
        obj_id = uuid.uuid4()
    ...
    async def test_exists(self, repo, db_session):
        """Test checking if a invoice exists."""
        mock_result = MagicMock()
    ...
    async def test_count(self, repo, db_session):
        """Test counting invoices with tenant filter."""
        mock_result = MagicMock()
    ...
    async def test_search_pagination(self, repo, db_session):
        """Test searching and paginating invoices."""
        mock_obj = MagicMock(spec=Invoice)
        mock_result = MagicMock()
